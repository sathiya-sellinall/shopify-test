...
<#assign variants = "[">
	<#assign variants = variants + "{">
			...
			<#assign variants = variants + "\"weight\" : \""><#if exchange.properties.shopifyInstance.shopify.weight??><#assign variants = variants + exchange.properties.shopifyInstance.shopify.weight+"\","><#else><#assign variants = variants + "\","></#if>
